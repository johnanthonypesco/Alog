...
<body>
    ...
    <main class="ml-0 md:ml-64 px-5 md:px-10 min-h-screen transition-all duration-300 ease-in-out" id="main">
        ...
        <div class="flex flex-col lg:flex-row justify-between items-center">
            ...
            <div id="addarchivebtn" class="flex gap-2 items-center">
                <button id="createreleasebtn" class="w-fit h-fit p-2 bg-[#046636] rounded-lg px-5 text-white font-bold">
                    Create Releases
                </button>
                <button id="archivedreleasebtn" class="w-fit h-fit p-2 bg-[#046636]/20 border-2 border-[#046636] rounded-lg px-5 text-[#046636] font-bold">
                    Archived Releases
                </button>
            </div>
        ...
        <h1 class="text-blue-700/70 text-3xl font-bold mt-10">Storage 1</h1>
        <div class="flex flex-col lg:flex-row justify-between items-center">
            <h1 class="text-3xl font-bold text-[#EB7100]">Chemichals</h1>
            <div id="addarchivebtn" class="flex gap-2 items-center">
                <button id="createreleasebtn" class="w-fit h-fit p-2 bg-[#046636] rounded-lg px-5 text-white font-bold">
                    Create Releases
                </button>
    ...
    <script src="{{ asset('js/admin/inventory/forrelease.js') }}"></script>
</body>
</html>