    ...
    <main class="ml-0 md:ml-64 px-5 md:px-10 min-h-screen transition-all duration-300 ease-in-out" id="main">
        ...
        <div class="flex flex-col lg:flex-row justify-between items-center mt-10">
            ...
            <div class="flex gap-2 items-center">
                ...
                <button id="archivedstockbtn" class="w-fit h-fit bg-[#046636]/20 border-2 border-[#046636] p-1 rounded-lg px-5 text-[#046636] font-bold">
                    Archived Stock
                </button>
            </div>
        </div>
...
<script>
    ...
    function archivedstockmodal() {
        ...
        const openModalButton = document.getElementById('archivedstockbtn');
        const closeModalButton = document.getElementById('closearchivedstockmodal');
