...
<body>
    ...
    <main class="ml-0 md:ml-64 px-5 md:px-10 min-h-screen transition-all duration-300 ease-in-out" id="main">
        ...
        <x-admin.modal modalid="viewarchiverolemodal" modaltitle="Arhived Roles" closemodal="closeviewarchiverolemodal">
            <div class="w-full overflow-auto border-2 border-[#046636] rounded-lg mt-5">
                <table class="w-full">
                    <thead class="bg-[#046636]/20">
                        <tr>
                    ...
                    <tbody>
                        <tr>
                            ...
                            <td>
                                <div class="flex items-center justify-center gap-2">
                                    <button id="editemployeerolebtn" class="p-2 bg-blue-200 rounded-md"><i class="fa-solid fa-rotate-left text-blue-700"></i></button>
                                    <button class="p-2 bg-red-200 rounded-md"><i class="fa-solid fa-trash text-red-700"></i></button>
                                </div>
                            </td>
                        </tr>
                        <tr>
                            ...
                            <td>
                                <div class="flex items-center justify-center gap-2">
                                    <button class="p-2 bg-blue-200 rounded-md"><i class="fa-solid fa-rotate-left text-blue-700"></i></button>
                                    <button class="p-2 bg-red-200 rounded-md"><i class="fa-solid fa-trash text-red-700"></i></button>
                                </div>
                            </td>
                        </tr>
        ...
        {{-- Edit Employee Role --}}
        <x-admin.modal  modalid="editemployeerolemodal" modaltitle="Edit Employee Role" 
            closemodal="closeeditemployeerolemodal" modalwidth="max-w-5xl mx-auto overflow-y-auto max-h-[90vh]">
